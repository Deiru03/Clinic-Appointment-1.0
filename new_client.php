...
<div class="col-lg-12">
	<div class="card">
		<div class="card-body">
			...
			<input type="hidden" name="fullname" id="fullname" value="<?php echo isset($firstname) ? $firstname : '' ?> <?php echo isset($middlename) ? $middlename : '' ?> <?php echo isset($lastname) ? $lastname : '' ?>">
				<div class="row">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					<button class="btn btn-primary mr-2">Save Client</button>
